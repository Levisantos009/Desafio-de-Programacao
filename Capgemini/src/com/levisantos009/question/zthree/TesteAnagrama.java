...
class TesteAnagrama {
	 ...
	 *  
	 *  MUITOS CANDIDATOS IRÃO ERRAR CASO 
	 *  NÃO TENHAM ATUALIZADO SEUS ALGORITMOS.
	 *  
	...
	private void erro() throws Exception {
		throw new Exception("Saída inesperada, corrija sua lógica!");
	}
	
	private void erroUser() throws Exception {
		throw new Exception("Digite uma palavra válida!");
	}
